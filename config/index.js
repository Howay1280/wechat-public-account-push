export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx2d3f1e11d224d29d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "2423b15ecd96f12b13281a02b0d6bfb2",
  ...
  USERS: [
    {
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "oTCjt6s14oUgGeRXI-TAWLFV1rAk",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "河南周口",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "宝宝", "year": "2005", "date": "02-06"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "节日", "name": "我们认识", "year": "2022", "date": "08-12"},
      ],
